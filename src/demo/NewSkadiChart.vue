...
const renderChart = (chartType: ChartType) => {
  ...
  if (chartType === "default") {
    new ChartNew("default", container)
      ...
      .configureTicks({
        ...
        y: { numerical: { specifier: ".1f", count: 5 } },
      })
      .startVisual()
      .addAxes()
      .startInteractive()
  ...
  if (chartType === "categoricalXY") {
    new ChartNew("categoricalXY", container)
      ...
      .configureTicks({
        x: { categorical: { padding: 36, formatter: (s) => s.toUpperCase() }, numerical: { count: 3 } },
        y: { categorical: { padding: 20 }, numerical: { specifier: ".0f" } },
      })
      .startVisual()
      .addAxes()
      .startInteractive()
  ...
  if (chartType === "categoricalX") {
    new ChartNew("categoricalX", container)
      ...
      .configureTicks({
        x: { categorical: { padding: 36, formatter: (s) => s.toUpperCase() } },
        y: { numerical: { size: 6, padding: 4, formatter: (num) => `v=${num}` } },
      })
      .startVisual()
      .addAxes()
      .startInteractive()
  ...
  new ChartNew("categoricalY", container)
    ...
    .configureTicks({
      y: { categorical: { padding: 30, formatter: (s) => s.replace("Category ", "Cat ") } },
    })
    .startVisual()
    .addAxes()
    .startInteractive()
